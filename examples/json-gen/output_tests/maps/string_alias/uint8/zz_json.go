...
func ast_uint8_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Map_uint8_StringAlias_To_uint8((*map[StringAlias]uint8)(obj))
}

func ast_Map_uint8_StringAlias_To_uint8(obj *map[StringAlias]uint8) (libjson.Value, error) {
