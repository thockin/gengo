...
func ast_int32_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Map_int32_StringAlias_To_int32((*map[StringAlias]int32)(obj))
}

func ast_Map_int32_StringAlias_To_int32(obj *map[StringAlias]int32) (libjson.Value, error) {
