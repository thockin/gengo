...
func ast_int8_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Map_int8_StringAlias_To_int8((*map[StringAlias]int8)(obj))
}
...
func ast_Map_int8_StringAlias_To_int8(obj *map[StringAlias]int8) (libjson.Value, error) {
