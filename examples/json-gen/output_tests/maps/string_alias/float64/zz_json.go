...
func ast_float64_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Map_float64_StringAlias_To_float64((*map[StringAlias]float64)(obj))
}

func ast_Map_float64_StringAlias_To_float64(obj *map[StringAlias]float64) (libjson.Value, error) {
