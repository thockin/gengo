...
func (obj Ttest) MarshalJSON() ([]byte, error) {
	jv, err := ast_text_marshal_struct_alias_Ttest(&obj)
	if err != nil {
		return nil, err
	}
...
func ast_text_marshal_struct_alias_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Map_text_marshal_struct_alias_KeyType_To_string((*map[KeyType]string)(obj))
}

func ast_Map_text_marshal_struct_alias_KeyType_To_string(obj *map[KeyType]string) (libjson.Value, error) {
