...
func (obj Ttest) MarshalJSON() ([]byte, error) {
	jv, err := ast_slice_string_Ttest(&obj)
	if err != nil {
		return nil, err
	}
...
func ast_slice_string_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Map_string_To_Slice_string((*map[string][]string)(obj))
}

func ast_Map_string_To_Slice_string(obj *map[string][]string) (libjson.Value, error) {
	...
	add := func(ks string) libjson.Value {
		...
		vals = append(vals, x)
		obj := &vals[len(vals)-1]
		jv, _ := ast_Slice_string((*[]string)(obj))
		//FIXME: handle error?
		return jv
	}
