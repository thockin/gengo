...
func ast_string_alias_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Map_string_To_string_alias_StringAlias((*map[string]StringAlias)(obj))
}
...
func ast_Map_string_To_string_alias_StringAlias(obj *map[string]StringAlias) (libjson.Value, error) {
