...
func (obj Ttest) MarshalJSON() ([]byte, error) {
	jv, err := ast_ptr_string_Ttest(&obj)
	if err != nil {
		return nil, err
	}
...
func ast_ptr_string_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Map_string_To_Pointer_string((*map[string]*string)(obj))
}

func ast_Map_string_To_Pointer_string(obj *map[string]*string) (libjson.Value, error) {
