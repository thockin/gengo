...
func ast_ptr_to_strings_Ttest(obj *Ttest) (libjson.Value, error) {
	...
	// F []struct{F1 *string; F2 *string; F3 *string}
	{
		...
		jv, err := ast_Slice_Struct_Pointer_string_Pointer_string_Pointer_string((*[]struct {
			F1 *string
			F2 *string
			F3 *string
		})(obj))
...
func ast_Slice_Struct_Pointer_string_Pointer_string_Pointer_string(obj *[]struct {
	F1 *string
	F2 *string
	F3 *string
}) (libjson.Value, error) {
	...
	get := func() ([]libjson.Value, error) {
		...
		for i := range *obj {
			...
			jv, err := ast_Struct_Pointer_string_Pointer_string_Pointer_string((*struct {
				F1 *string
				F2 *string
				F3 *string
			})(obj))
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Struct_Pointer_string_Pointer_string_Pointer_string((*struct {
			F1 *string
			F2 *string
			F3 *string
		})(obj))
...
func ast_Struct_Pointer_string_Pointer_string_Pointer_string(obj *struct {
	F1 *string
	F2 *string
	F3 *string
}) (libjson.Value, error) {
