...
func ast_float32s_Ttest(obj *Ttest) (libjson.Value, error) {
	...
	// F *struct{F1 float32; F2 float32; F3 float32}
	{
		...
		jv, err := ast_Pointer_Struct_F1_float32_F2_float32_F3_float32((**struct {
			F1 float32
			F2 float32
			F3 float32
		})(obj))
...
func ast_Pointer_Struct_F1_float32_F2_float32_F3_float32(obj **struct {
	F1 float32
	F2 float32
	F3 float32
}) (libjson.Value, error) {
	...
	if *obj != nil {
		obj := *obj
		jv, err = ast_Struct_F1_float32_F2_float32_F3_float32((*struct {
			F1 float32
			F2 float32
			F3 float32
		})(obj))
	...
	setNull := func(b bool) (libjson.Value, error) {
		...
		*obj = new(struct {
		...
		obj := *obj
		return ast_Struct_F1_float32_F2_float32_F3_float32((*struct {
			F1 float32
			F2 float32
			F3 float32
		})(obj))
...
func ast_Struct_F1_float32_F2_float32_F3_float32(obj *struct {
	F1 float32
	F2 float32
	F3 float32
}) (libjson.Value, error) {
