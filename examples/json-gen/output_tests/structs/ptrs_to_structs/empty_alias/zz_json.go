...
func ast_empty_alias_Ttest(obj *Ttest) (libjson.Value, error) {
	...
	// F *k8s.io/gengo/examples/json-gen/./output_tests/structs/ptrs_to_structs/empty_alias.Inner
	{
		...
		jv, err := ast_Pointer_empty_alias_Inner((**Inner)(obj))
		if err != nil {
			return nil, err
		}
		if !empty(jv) {
...
func ast_Pointer_empty_alias_Inner(obj **Inner) (libjson.Value, error) {

	var jv libjson.Value
	var err error
	if *obj != nil {
		obj := *obj
		jv, err = ast_empty_alias_Inner((*Inner)(obj))
		if err != nil {
			return nil, err
		}
	}
	setNull := func(b bool) (libjson.Value, error) {
		...
		*obj = new(Inner)
		obj := *obj
		return ast_empty_alias_Inner((*Inner)(obj))
	}
