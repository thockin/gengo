...
func ast_ptr_string_T(obj *ptr_string.T) (libjson.Value, error) {
...
func Marshal_ptr_string_T(obj ptr_string.T) ([]byte, error) {
	val, err := ast_ptr_string_T(&obj)
	if err != nil {
		return nil, err
	}
...
func Unmarshal_ptr_string_T(data []byte, obj *ptr_string.T) error {
	val, err := ast_ptr_string_T(obj)
	if err != nil {
		return err
	}
