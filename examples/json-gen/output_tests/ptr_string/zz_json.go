...
func ast_ptr_string_T(obj *T) (libjson.Value, error) {
...
func Marshal_ptr_string_T(obj T, buf *bytes.Buffer) error {
...
func Unmarshal_ptr_string_T(data []byte, obj *T) error {
	val, err := ast_ptr_string_T(obj)
	if err != nil {
		return err
	}
