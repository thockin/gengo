...
func ast_string_alias_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Pointer_string_alias_Elem((*[]*Elem)(obj))
}
...
func ast_Slice_Pointer_string_alias_Elem(obj *[]*Elem) (libjson.Value, error) {
	...
	get := func() ([]libjson.Value, error) {
		...
		for i := range *obj {
			...
			jv, err := ast_Pointer_string_alias_Elem((**Elem)(obj))
			if err != nil {
				return nil, err
			}
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Pointer_string_alias_Elem((**Elem)(obj))
		//FIXME: handle error?
		return jv
	}
...
func ast_Pointer_string_alias_Elem(obj **Elem) (libjson.Value, error) {

	var jv libjson.Value
	var err error
	if *obj != nil {
		obj := *obj
		jv, err = ast_string_alias_Elem((*Elem)(obj))
		if err != nil {
			return nil, err
		}
	}
	setNull := func(b bool) (libjson.Value, error) {
		...
		*obj = new(Elem)
		obj := *obj
		return ast_string_alias_Elem((*Elem)(obj))
	}
	return libjson.NewNullable(jv, setNull), nil
