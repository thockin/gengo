...
func ast_float64_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Slice_Pointer_float64((*[][]*float64)(obj))
}

func (obj Ttest) MarshalJSON() ([]byte, error) {
	jv, err := ast_float64_Ttest(&obj)
	if err != nil {
		return nil, err
	}
...
func ast_Slice_Slice_Pointer_float64(obj *[][]*float64) (libjson.Value, error) {
	...
	get := func() ([]libjson.Value, error) {
		...
		for i := range *obj {
			...
			jv, err := ast_Slice_Pointer_float64((*[]*float64)(obj))
			if err != nil {
				return nil, err
			}
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Slice_Pointer_float64((*[]*float64)(obj))
		//FIXME: handle error?
		return jv
	}
...
func ast_Slice_Pointer_float64(obj *[]*float64) (libjson.Value, error) {
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Pointer_float64((**float64)(obj))
		//FIXME: handle error?
		return jv
	}
	var jv libjson.Value
