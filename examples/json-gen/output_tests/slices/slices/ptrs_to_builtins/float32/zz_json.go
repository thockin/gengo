...
func ast_float32_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Slice_Pointer_float32((*[][]*float32)(obj))
}
...
func ast_Slice_Slice_Pointer_float32(obj *[][]*float32) (libjson.Value, error) {
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Slice_Pointer_float32((*[]*float32)(obj))
		//FIXME: handle error?
		return jv
	}
