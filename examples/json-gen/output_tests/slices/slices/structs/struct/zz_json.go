...
func ast_struct_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Slice_Struct_F1_struct_Elem_F2_struct_Elem((*[][]struct {
		F1 Elem
		F2 Elem
	})(obj))
}

func ast_Slice_Slice_Struct_F1_struct_Elem_F2_struct_Elem(obj *[][]struct {
	F1 Elem
	F2 Elem
}) (libjson.Value, error) {
	...
	get := func() ([]libjson.Value, error) {
		...
		for i := range *obj {
			...
			jv, err := ast_Slice_Struct_F1_struct_Elem_F2_struct_Elem((*[]struct {
				F1 Elem
				F2 Elem
			})(obj))
			if err != nil {
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Slice_Struct_F1_struct_Elem_F2_struct_Elem((*[]struct {
			F1 Elem
			F2 Elem
		})(obj))
		//FIXME: handle error?
...
func ast_Struct_F1_struct_Elem_F2_struct_Elem(obj *struct {
	...
	// F1 k8s.io/gengo/examples/json-gen/./output_tests/slices/slices/structs/struct.Elem
	{
		obj := &obj.F1
	...
	// F2 k8s.io/gengo/examples/json-gen/./output_tests/slices/slices/structs/struct.Elem
	{
		obj := &obj.F2
