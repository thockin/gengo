...
func ast_string_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Slice_Struct_string_string((*[][]struct {
		F1 string
		F2 string
	})(obj))
}
...
func ast_Slice_Slice_Struct_string_string(obj *[][]struct {
	F1 string
	F2 string
}) (libjson.Value, error) {
	...
	get := func() ([]libjson.Value, error) {
		...
		for i := range *obj {
			...
			jv, err := ast_Slice_Struct_string_string((*[]struct {
				F1 string
				F2 string
			})(obj))
			if err != nil {
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Slice_Struct_string_string((*[]struct {
			F1 string
			F2 string
		})(obj))
		//FIXME: handle error?
...
func ast_Slice_Struct_string_string(obj *[]struct {
	F1 string
	F2 string
}) (libjson.Value, error) {
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Struct_string_string((*struct {
			F1 string
			F2 string
		})(obj))
		//FIXME: handle error?
