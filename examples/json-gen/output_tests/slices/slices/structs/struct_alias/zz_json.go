...
func ast_struct_alias_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Slice_struct_alias_Outer((*[][]Outer)(obj))
}
...
func ast_Slice_Slice_struct_alias_Outer(obj *[][]Outer) (libjson.Value, error) {
	...
	get := func() ([]libjson.Value, error) {
		...
		for i := range *obj {
			...
			jv, err := ast_Slice_struct_alias_Outer((*[]Outer)(obj))
			if err != nil {
				return nil, err
			}
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Slice_struct_alias_Outer((*[]Outer)(obj))
		//FIXME: handle error?
		return jv
	}
...
func ast_Slice_struct_alias_Outer(obj *[]Outer) (libjson.Value, error) {
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_struct_alias_Outer((*Outer)(obj))
		//FIXME: handle error?
		return jv
	}
	var jv libjson.Value
...
func ast_struct_alias_Outer(obj *Outer) (libjson.Value, error) {
	...
	// F2 k8s.io/gengo/examples/json-gen/./output_tests/slices/slices/structs/struct_alias.Inner
	{
		obj := &obj.F2
		_ = obj //FIXME: remove when other Kinds are done
