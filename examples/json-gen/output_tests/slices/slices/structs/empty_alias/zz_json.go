...
func ast_empty_alias_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Slice_empty_alias_Elem((*[][]Elem)(obj))
}

func ast_Slice_Slice_empty_alias_Elem(obj *[][]Elem) (libjson.Value, error) {
	...
	get := func() ([]libjson.Value, error) {
		...
		for i := range *obj {
			...
			jv, err := ast_Slice_empty_alias_Elem((*[]Elem)(obj))
			if err != nil {
				return nil, err
			}
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Slice_empty_alias_Elem((*[]Elem)(obj))
		//FIXME: handle error?
		return jv
	}
...
func ast_Slice_empty_alias_Elem(obj *[]Elem) (libjson.Value, error) {
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_empty_alias_Elem((*Elem)(obj))
		//FIXME: handle error?
		return jv
	}
	var jv libjson.Value
