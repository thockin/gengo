...
func ast_mixed_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Slice_Struct_F1_int32_F2_Pointer_int32_F3_float32_F4_Pointer_float32_F5_string_F6_Pointer_string_F7_Struct_F_string_F8_Pointer_Struct_F_string((*[][]struct {
		F1 int32
		F2 *int32
		F3 float32
		F4 *float32
...
func ast_Slice_Slice_Struct_F1_int32_F2_Pointer_int32_F3_float32_F4_Pointer_float32_F5_string_F6_Pointer_string_F7_Struct_F_string_F8_Pointer_Struct_F_string(obj *[][]struct {
	F1 int32
	F2 *int32
	F3 float32
	F4 *float32
	...
	get := func() ([]libjson.Value, error) {
		...
		for i := range *obj {
			...
			jv, err := ast_Slice_Struct_F1_int32_F2_Pointer_int32_F3_float32_F4_Pointer_float32_F5_string_F6_Pointer_string_F7_Struct_F_string_F8_Pointer_Struct_F_string((*[]struct {
				F1 int32
				F2 *int32
				F3 float32
				F4 *float32
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Slice_Struct_F1_int32_F2_Pointer_int32_F3_float32_F4_Pointer_float32_F5_string_F6_Pointer_string_F7_Struct_F_string_F8_Pointer_Struct_F_string((*[]struct {
			F1 int32
			F2 *int32
			F3 float32
			F4 *float32
...
func ast_Slice_Struct_F1_int32_F2_Pointer_int32_F3_float32_F4_Pointer_float32_F5_string_F6_Pointer_string_F7_Struct_F_string_F8_Pointer_Struct_F_string(obj *[]struct {
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Struct_F1_int32_F2_Pointer_int32_F3_float32_F4_Pointer_float32_F5_string_F6_Pointer_string_F7_Struct_F_string_F8_Pointer_Struct_F_string((*struct {
			F1 int32
			F2 *int32
			F3 float32
			F4 *float32
