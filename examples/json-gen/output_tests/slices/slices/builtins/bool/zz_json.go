...
func ast_bool_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Slice_bool((*[][]bool)(obj))
}

func ast_Slice_Slice_bool(obj *[][]bool) (libjson.Value, error) {
	...
	get := func() ([]libjson.Value, error) {
		...
		for i := range *obj {
			...
			jv, err := ast_Slice_bool((*[]bool)(obj))
			if err != nil {
				return nil, err
			}
...
func ast_Slice_bool(obj *[]bool) (libjson.Value, error) {
