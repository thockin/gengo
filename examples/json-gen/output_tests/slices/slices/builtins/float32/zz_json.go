...
func ast_float32_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Slice_float32((*[][]float32)(obj))
}
...
func ast_Slice_Slice_float32(obj *[][]float32) (libjson.Value, error) {
	...
	get := func() ([]libjson.Value, error) {
		...
		for i := range *obj {
			...
			jv, err := ast_Slice_float32((*[]float32)(obj))
			if err != nil {
				return nil, err
			}
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Slice_float32((*[]float32)(obj))
		//FIXME: handle error?
		return jv
	}
...
func ast_Slice_float32(obj *[]float32) (libjson.Value, error) {
