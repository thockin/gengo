...
func ast_ptr_to_string_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Pointer_Slice_Pointer_string((*[]*[]*string)(obj))
}

func (obj Ttest) MarshalJSON() ([]byte, error) {
	jv, err := ast_ptr_to_string_Ttest(&obj)
	if err != nil {
		return nil, err
	}
...
func ast_Slice_Pointer_Slice_Pointer_string(obj *[]*[]*string) (libjson.Value, error) {
	...
	get := func() ([]libjson.Value, error) {
		...
		for i := range *obj {
			...
			jv, err := ast_Pointer_Slice_Pointer_string((**[]*string)(obj))
			if err != nil {
				return nil, err
			}
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Pointer_Slice_Pointer_string((**[]*string)(obj))
		//FIXME: handle error?
		return jv
	}
...
func ast_Pointer_Slice_Pointer_string(obj **[]*string) (libjson.Value, error) {
