...
func ast_string_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Pointer_Slice_string((*[]*[]string)(obj))
}

func ast_Slice_Pointer_Slice_string(obj *[]*[]string) (libjson.Value, error) {
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Pointer_Slice_string((**[]string)(obj))
		//FIXME: handle error?
		return jv
	}
