...
func ast_slice_struct_string_Ttest(obj *Ttest) (libjson.Value, error) {
	return ast_Slice_Struct_string((*[]struct{ F string })(obj))
}

func (obj Ttest) MarshalJSON() ([]byte, error) {
	jv, err := ast_slice_struct_string_Ttest(&obj)
	if err != nil {
		return nil, err
	}
...
func ast_Slice_Struct_string(obj *[]struct{ F string }) (libjson.Value, error) {
	...
	add := func() libjson.Value {
		...
		*obj = append(*obj, x)
		obj := &(*obj)[len(*obj)-1]
		jv, _ := ast_Struct_string((*struct{ F string })(obj))
		//FIXME: handle error?
		return jv
	}
	setNull := func(b bool) {
